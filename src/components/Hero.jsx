      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <div className="hero-btns" style={{flexWrap: 'wrap'}}>
            ...
            <a href="https://drive.google.com/file/d/1_WrN2dyDMypggnYON-XcZ7uMKo6noyDv/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn-outline">
